...
public class TrapezoidChart2D extends Activity 
{
   ...
   private static class SimpleView extends View 
   {
      ...
      private int trapezoidWidth    = barWidth/3;
      ...
      private Path  trapezoidPath   = null;
      private Paint trapezoidPaint  = null;
      ...
      private void initialize()
      {
       ...
       //textPaint.setStrokeWidth(colorStrokeWidth); 
         ...
         trapezoidPaint.setStrokeWidth(lineThickness); 

         trapezoidPaint.setAntiAlias(true);
         trapezoidPaint.setDither(true);
         trapezoidPaint.setStrokeJoin(Paint.Join.ROUND);
         trapezoidPaint.setStrokeCap(Paint.Cap.ROUND);
      ...
      private void renderBars(Canvas canvas)
      {
         for(int bar=0; bar<barCount; bar++) 
         {
            ...
            // render single bar 
            trapezoidPaint.setColor(barColors[bar%2]); 
...
//                          trapezoidPaint);
            ...
            trapezoidPath = new Path();
  
            trapezoidPath.moveTo(currentX+(barWidth-trapezoidWidth)/2, 
                                currentY);

            trapezoidPath.lineTo(currentX2-(barWidth-trapezoidWidth)/2, 
                                currentY);

            trapezoidPath.lineTo(currentX2, currentY2);
            trapezoidPath.lineTo(currentX,  currentY2);
