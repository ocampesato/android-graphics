...
public class LituusOval1Tube1 extends Activity 
{
   ...
   {
      private int basePointX        = 115;
      private int basePointY        = 105;
      ...
      private void renderGraphics(Canvas canvas)
      {
         for(angle=1; angle<maxAngle; angle+=deltaAngle) 
         {
            ...
            currStrip  = (int)(Math.floor(angle/deltaAngle/stripWidth));
            ...
            ovalRectF = new RectF(currentX,
                                  currentY,
                                  currentX+factor*majorAxis,
                                  currentY+factor*minorAxis);
