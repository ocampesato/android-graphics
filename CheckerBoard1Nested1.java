...
public class CheckerBoard1Nested1 extends Activity 
{
      ...
      private void renderGraphics(Canvas canvas)
      {
         for(int row=0; row<rowCount; row++)
         {
            for(int col=0; col<colCount; col++)
            {
               ...
               canvas.drawRect(currentX+cellWidth/4, 
                               currentY+cellWidth/4,
                               currentX+3*cellWidth/4, 
                               currentY+3*cellHeight/4,
                               rectPaint);
            }
         }
      }
